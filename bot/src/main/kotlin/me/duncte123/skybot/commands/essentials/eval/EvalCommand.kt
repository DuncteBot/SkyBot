...
package me.duncte123.skybot.commands.essentials.eval
    ...
    private val engine: ScriptEngine by lazy {
        ScriptEngineManager().getEngineByExtension("kts")!!.apply {
            val packageImports = listOf(
                ...
                "me.duncte123.skybot.utils",
                "me.duncte123.skybot.entities",
                "me.duncte123.skybot",
                "me.duncte123.skybot.objects.command"
            )

            val classImports = listOf(
                "fredboat.audio.player.LavalinkManager",
                "me.duncte123.skybot.objects.EvalFunctions",
