...
import me.duncte123.skybot.Settings.NEKKO_BASE
import me.duncte123.skybot.objects.command.Command
import me.duncte123.skybot.objects.command.CommandCategory
import me.duncte123.skybot.objects.command.CommandContext

class LewdKitsuneCommand : Command() {
    init {
        this.category = CommandCategory.NSFW
        this.name = "lewdkitsune"
        this.help = "Shows you a lewd kitsune"
    }

    override fun execute(ctx: CommandContext) {
        WebUtils.ins.getJSONObject("${NEKKO_BASE}lewdkitsune").async {
