...
public abstract class OAuth2Action<T>
{
     ...
     * as the parameter given to the success {@link Consumer Consumer}.
     *
     * @param  success
    ...
    /**
     * Asynchronously executes this OAuth2Action, providing the value constructed from the response
     * as the parameter given to the success {@link Consumer Consumer} if the
     ...
     * if it was successful, or throwing the {@link Exception Exception} if it was not.
     *
     ...
     * @throws IOException on unsuccessful execution
     */
