 ...
 *
 * <p>OAuth2Client's are made using a {@link Builder OAuth2Client.Builder},
...
public interface OAuth2Client
{
    ...
    /**
     * Starts a {@link Session Session} with the provided code,
     * state, and identifier. The state provided should be <i>unique</i> and provided through an
     * implementation of {@link StateController StateController}.
     *
     ...
     *         The provided scopes.
     *
     * @return A {@link OAuth2Action OAuth2Action} for the Session to start.
     *
    ...
    /**
     * Requests a {@link OAuth2User OAuth2User}
     * from the {@link Session Session}.
     *
     ...
     *
     * @return A {@link OAuth2Action OAuth2Action} for
    ...
    /**
     * Gets the client's {@link StateController StateController}.
     *
    ...
    /**
     * Gets the client's {@link SessionController SessionController}.
     *
    ...
    class Builder
    {
        ...
        /**
         * Finalizes and builds an {@link OAuth2Client OAuth2Client}
        ...
        /**
         * Sets the OAuth2Client's {@link SessionController SessionController}.
         *
        ...
        /**
         * Sets the OAuth2Client's {@link StateController StateController}.
         *
        ...
        /**
         * Sets the client's internal {@link OkHttpClient OkHttpClient} used for
