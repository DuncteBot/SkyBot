 ...
 * {@link OAuth2Client#getUser(Session) OAuth2Client#getUser}.
 *
...
{
    /**
     * Gets the underlying {@link OAuth2Client OAuth2Client}
     ...
     * from the provided instance of {@link JDA JDA}.
     *
    ...
    /**
     * Gets the corresponding {@link User JDA User}
     * from the provided {@link ShardManager ShardManager}.
     *
     * <p>Note that there is no guarantee that this will not return {@code null}
