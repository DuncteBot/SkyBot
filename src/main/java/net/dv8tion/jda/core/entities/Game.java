 ...
 * @author John A. Grosh
 *
 * This class has been copied from https://github.com/DV8FromTheWorld/JDA/blob/feature/game-types/src/main/java/net/dv8tion/jda/core/entities/Game.java
 * and overrides the original game class to allow the bot to see the listening and watching status
 * it will also allow the bot to use the status
 */
public class Game
{
