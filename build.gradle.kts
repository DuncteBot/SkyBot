...
dependencies {
    ...
    implementation(group = "net.dv8tion", name = "JDA", version = "4.1.1_161") {
...
//    implementation(group = "com.sedmelluq", name = "lavaplayer", version = "1.3.33")
    ...
    implementation(group = "com.github.duncte123", name = "lavaplayer", version = "dad33f1")
